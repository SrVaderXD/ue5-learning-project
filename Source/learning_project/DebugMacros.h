...
#define DRAW_POINT(Location) if (GetWorld()) DrawDebugPoint(GetWorld(), Location, 30.f, FColor::Emerald, true);
#define DRAW_VECTOR(StartLocation, EndLocation) if (GetWorld()) \
	{ \
		DrawDebugLine(GetWorld(), StartLocation, EndLocation, FColor::Blue, true, -1.f, 0, 1.f); \
		DrawDebugPoint(GetWorld(), EndLocation, 30.f, FColor::Emerald, true);\
	}
#define DRAW_BOX(Location, Extent, Color) if (GetWorld()) DrawDebugBox(GetWorld(), Location, Extent, Color, true, -1.f, 0, 1.f);
...
#define DRAW_POINT_SingleFrame(Location) if (GetWorld()) DrawDebugPoint(GetWorld(), Location, 30.f, FColor::Emerald, false, -1.f);
#define DRAW_VECTOR_SingleFrame(StartLocation, EndLocation) if (GetWorld()) \
	{ \
		DrawDebugLine(GetWorld(), StartLocation, EndLocation, FColor::Blue, false, -1.f, 0, 1.f); \
		DrawDebugPoint(GetWorld(), EndLocation, 30.f, FColor::Emerald, false, -1.f);\
	}
#define DRAW_BOX_SingleFrame(Location, Extent) if (GetWorld()) DrawDebugBox(GetWorld(), Location, Extent, FColor::Black, false, -1.f, 0, 1.f);
